            ...
            <div class="main-content col-lg-12">
                <div class="content-area card">
                    <div class="card-innr">
                        ...
                        <div class="gaps-2x"></div>
                        <h5>Price Chart <span class="badge badge-auto badge-xs badge-success">GET</span> <span class="badge badge-auto badge-dim badge-xs badge-success">/price_chart</span></h5>
                        <code class="code-block">
                        {{ api_route('price_chart') }}&minutes=1440
                        </code>
                        
                        <div class="gaps-2x"></div>
                        <h5>Transactions <span class="badge badge-auto badge-xs badge-success">GET</span> <span class="badge badge-auto badge-dim badge-xs badge-success">/transactions</span></h5>
                        <code class="code-block">
                        {{ api_route('transactions') }}
                        </code>

                        <div class="gaps-2x"></div>
                        <h5>Recent Transactions (last 12 hours of pending and approved transactions) <span class="badge badge-auto badge-xs badge-success">GET</span> <span class="badge badge-auto badge-dim badge-xs badge-success">/recent</span></h5>
                        <code class="code-block">
                        {{ api_route('recent_transactions') }}
                        </code>
                        
                        <div class="gaps-2x"></div>
                        <h5>Price Data <span class="badge badge-auto badge-xs badge-success">GET</span> <span class="badge badge-auto badge-dim badge-xs badge-success">/price_data</span></h5>
                        <code class="code-block">
                        {{ api_route('price_data') }}
                        </code>
