        ...
        <div class="card content-area">
            <div class="card-innr">
                <div class="card-head d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">NOWPayments API <br class="d-block d-sm-none">Setting <span class="badge badge-xs badge-purple ucap">Add-ons</span></h4>
                ...
                <div class="card-text wide-max-md">
                    <p>NOWPayments is online crypto payment gateway that helps to accept payments from your contributors.</p>
                    <p>These currencies 'ETH', 'BTC', 'LTC', 'BCH', 'BNB', 'XRP', 'TRX', 'USDT', 'USDC', 'DASH', and more are supported through this payment gateway.</p>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('admin.ajax.payments.update') }}" method="POST" class="payment_methods_form validate-modern">
                            @csrf
                            <input type="hidden" name="req_type" value="nowpayments">
                            ...
                            <p>Enter your NOWPayments public & private API credentials to receive payments and verify automatically.</p>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="input-item input-with-label">
                                        <label class="input-item-label">Secret Key</label>
                                        <div class="input-wrap">
                                            <input class="input-bordered" name="cnp_api2" autocomplete="new-password" value="{{ (is_demo_user() || is_demo_preview()) ? show_str($pmData->secret->secretKey, 10) : $pmData->secret->secretKey }}" type="text" placeholder="Place here your Private Key">
                                        </div>
                                    </div>
                                    <div class="input-item input-with-label">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-item input-with-label">
                                        <label class="input-item-label">Test Mode</label>
                                        <div class="input-wrap input-wrap-switch">
