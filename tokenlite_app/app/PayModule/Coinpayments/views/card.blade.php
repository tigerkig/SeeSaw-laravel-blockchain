<div class="payment-card">
    <div class="payment-head">
        ...
        <div class="payment-logo">
            <img src="{{ asset('assets/images/pay-coinpayments-admin.png') }}" alt="CoinPayments">
        </div>
        <div class="payment-action">
            ...
            <div class="toggle-class dropdown-content dropdown-content-top-left">
                <ul class="dropdown-list">
                    ...
                    <li><a class="quick-action" href="javascript:void(0)" data-name="coinpayments">{{ $pmData->status == 'active' ? 'Disabled' : 'Enabled' }}</a></li>
                </ul>
            </div>
        </div>
    </div>{{-- .payment-head --}}
    <div class="payment-body">
        <h5 class="payment-title">CoinPayments Gateway</h5>
        <p class="payment-text">Receive online payments from contributors using CoinPayments.</p>
        
        @if($pmData->secret->publicApiKey == NULL)
    ...
    <div class="payment-footer">
        ...
        @else
        <span class="payment-id-title">API Key</span>
        <span class="payment-id">{{ show_str($pmData->secret->publicApiKey, 4) }}</span>
        @endif
    </div>{{-- .payment-footer --}}
</div>