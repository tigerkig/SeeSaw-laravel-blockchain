                    ...
                    <div class="card-innr">
                        ...
                        <div class="nav nav-tabs nav-tabs-line">
                            <ul class="nav mb-0" id="myTab" role="tablist">
                                ...
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#security">Security Settings</a></li>
            ...
            <div class="popup-body">
                ...
                <form class="validate-modern" action="{{ route('admin.ajax.profile.update') }}" method="POST" id="nio-user-2fa">
                    ...
                    <div class="pdb-1-5x">
                        ...
                        <p><strong>Step 2:</strong> Scan the QR code by your Google Authenticator app, or you can add the account manually.</p>
                        ...
                        <div class="gaps-2x"></div>
                        <p class="text-danger"><strong>Note: </strong> If you lost your phone or Uninstall the Google Authenticator app, then you will lose access to your account.</p>
                    </div>
                    @else
                    <div class="pdb-1-5x">
                        <div class="input-item">
