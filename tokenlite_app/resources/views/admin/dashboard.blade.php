        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="token-transaction card card-full-height">
                    <div class="card-innr">
                        <div class="card-head has-aside">
                            <h4 class="card-title card-title-sm">Top Country Registrations</h4>
                        </div>
                        <table class="table tnx-table">
                            <tbody>
                                <tr>
                                    ...
                                    <th>%</th>
                                    <th>Users</th>
                                    <th>{{ strtoupper($base_cur) }}</th>
                                    <th>{{ token_symbol() }}</th>
                                </tr>
                                @foreach($country_data['users'] as $i => $data)
                                <tr>
                                    <td class="d-sm-table-cell">
                                        <span class="sub">{{ $data['country'] }}</span>
                                    </td>
                                    <td class="d-sm-table-cell">
                                        <span class="sub ucap">{{ $data['percent'] }}</span>
                                    </td>
                                    <td class="d-sm-table-cell">
                                        <span class="sub ucap">
                                            {{ $data['users'] }}
            ...
            <div class="col-lg-6">
                <div class="token-transaction card card-full-height">
                    <div class="card-innr">
                        <div class="card-head has-aside">
                            <h4 class="card-title card-title-sm">Top Country Spenders</h4>
                        </div>
                        <table class="table tnx-table">
                            <tbody>
                                <tr>
                                ...
                                @foreach($country_data['spenders'] as $title => $data)
                                <tr>
                                    <td class="d-sm-table-cell">
                                        <span class="sub">{{ $data['country'] }}</span>
                                    </td>
            ...
            <div class="col-lg-6">
                <div class="token-transaction card card-full-height">
                    <div class="card-innr">
                        <div class="card-head has-aside">
                            <h4 class="card-title card-title-sm">Progress Stats</h4>
                        </div>
                        <table class="table tnx-table">
                            <tbody>
                                <tr>
                                    ...
                                    <th>Count</th>
                                    <th>{{ strtoupper($base_cur) }}</th>
                                    <th>{{ token_symbol() }} Amount</th>
                                </tr>
                                @foreach($progress_data as $title => $data)
                                <tr>
                                    <td class="d-sm-table-cell">
                                        <span class="sub">{{ $title }}</span>
                                    </td>
                                    <td class="d-sm-table-cell">
                                        <span class="sub ucap">{{ to_round($data['count'], 'min') }}</span>
                                    </td>
                                    <td class="d-sm-table-cell">
                                        <span class="sub ucap">
                                            {{ to_round($data['base_total'], 'min') }} {{ strtoupper($base_cur) }}
                                        </span>
                                    </td>
                                    <td class="d-sm-table-cell">
                                        <span class="sub ucap">
                                            {{ to_round($data['total'], 'min') }} {{ token_symbol() }}
                                        </span>
                                    </td>
                                </tr>
                                @endforeach
