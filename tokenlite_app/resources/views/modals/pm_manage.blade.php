                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="automatic_rate_time" id="rate_time" class="select select-bordered select-block">
                                        <option {{ get_setting('pm_automatic_rate_time') == 1 ? 'selected' : '' }} value="1">1 second</option>
                                        <option {{ get_setting('pm_automatic_rate_time') == 900 ? 'selected' : '' }} value="900">15 minute</option>
                                        <option {{ get_setting('pm_automatic_rate_time') == 1800 ? 'selected' : '' }} value="1800">30 minute</option>
                                        <option {{ get_setting('pm_automatic_rate_time') == 2700 ? 'selected' : '' }} value="2700">45 minute</option>
                                        <option {{ get_setting('pm_automatic_rate_time') == 3600 ? 'selected' : '' }} value="3600">1 hour</option>
                                        <option {{ get_setting('pm_automatic_rate_time') == 7200 ? 'selected' : '' }} value="7200">2 hour</option>
                                    </select>
                                    </div>
