    ...
    public static function base_translate_content() {
        $global = [
            ///// MESSAGES /////
              ...
              "messages.mobile.invalid" => [
                "text" => "Phone numbers should be at least 11 digits long and include country code.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              ...
              "messages.trnx.canceled" => [
                "text" => "This coin is currently unavailable please try a different coin for payment.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
            ...
            ///// USER PROFILE /////
              ...
              "profile.activitiy_note" => [
                "text" => "Here are your recent activities. You can clear this log as well as disable the feature from profile settings tabs.",
                "pages" => "user_profile, user_activity, global",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// ORDER PROCEDD /////
              ...
              "payment.info.crypto_receive" => [
                "text" => "To receive :token :symbol token, please send :amount :currency to the address below. The token balance will appear in your account only after transaction gets :num confirmation and approved by our team.",
                "pages" => "payment, order",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "payment.info.bank_receive" => [
                "text" => "To receive :token :symbol token, please make your payment of :amount :currency through bank to the below bank address. The token balance will appear in your account only after your transaction gets approved by our team.",
                "pages" => "payment, order",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "payment.info.gateway_receive" => [
                "text" => "To receive :token :symbol token, please make your payment of :amount :currency through :gateway. The token balance will appear in your account after we received your payment.",
                "pages" => "payment, order",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// USER WALLET /////
              ...
              "wallet.receive_info" => [
                "text" => "In order to receive your :SYMBOL token, please enter your wallet address below. You will receive your :SYMBOL token to this address after the token sale ends",
                "pages" => "user_wallet",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// AUTH 2FA /////
              ...
              "auth.2fa.auth" => [
                "text" => "Two-factor authentication is a method for protection of your account. When it is activated you are required to enter not only your password, but also a special code. You can receive this code in mobile app. Even if a third party individual gains access to your password, they still won't be able to access your account without the 2FA code.",
                "pages" => "user_2fa",
                "panel" => "user",
                "load" => 0
              ],
              "auth.2fa.lost_access" => [
                "text" => "If you lost your phone or uninstall the Google Authenticator app, then you will lose access to your account.",
                "pages" => "user_2fa",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "auth.2fa.scan_qr_code" => [
                "text" => "Scan the below QR code using your Google Authenticator app, or you can add the account manually.",
                "pages" => "user_2fa",
                "panel" => "user",
                "load" => 0
              ],
