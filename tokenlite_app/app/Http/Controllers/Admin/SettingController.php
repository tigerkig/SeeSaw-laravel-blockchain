...
class SettingController extends Controller
{
    ...
    public function update(Request $request) {
        ...
        if ($type == 'site_info') {
            ...
            Setting::updateValue('enforce_email_verification', isset($request->enforce_email_verification));
            ...
            Setting::updateValue('hubspot_api_key', $request->input('hubspot_api_key'));
            Setting::updateValue('hubspot_business_unit_id', $request->input('hubspot_business_unit_id'));
            Setting::updateValue('hubspot_pipeline_id', $request->input('hubspot_pipeline_id'));
            Setting::updateValue('hubspot_deal_stage_start_id', $request->input('hubspot_deal_stage_start_id'));
            Setting::updateValue('hubspot_deal_stage_end_id', $request->input('hubspot_deal_stage_end_id'));
