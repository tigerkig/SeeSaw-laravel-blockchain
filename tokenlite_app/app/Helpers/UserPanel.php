...
class UserPanel
{
    ...
    public static function user_token_block($data = '', $atttr = '')
    {
        ...
        if ($vers =='buy') {
            ...
            $return .= '<h3 class="text-dark">1 ' . $_SYM . ' = <span class="token-base-price-value">' . to_num($token_1price, 'max', ',', true) . '</span> ' . $_CUR .' <span class="d-block text-exlight ucap fs-12">1 '. $_CUR . ' = ' . to_num($token_1rate, 'max', ',', true) . ' ' . $token_ratec .'</span></h3>';
    ...
    public static function social_links($data = null, $atttr = '')
    {
        ...
        if (isset($link->facebook) && $link->facebook != null) {
            $social_html[] = '<li><a href="' . $link->facebook . '"><em class="fab fa-facebook-f"></em></a></li>';
        }
        if (isset($link->twitter) && $link->twitter != null) {
            $social_html[] = '<li><a href="' . $link->twitter . '""><em class="fab fa-twitter"></em></a></li>';
        }
        if (isset($link->linkedin) && $link->linkedin != null) {
            $social_html[] = '<li><a href="' . $link->linkedin . '"><em class="fab fa-linkedin-in"></em></a></li>';
        }
        if (isset($link->github) && $link->github != null) {
            $social_html[] = '<li><a href="' . $link->github . '"><em class="fab fa-github-alt"></em></a></li>';
        }
        if (isset($link->youtube) && $link->youtube != null) {
            $social_html[] = '<li><a href="' . $link->youtube . '"><em class="fab fa-youtube"></em></a></li>';
        }
        if (isset($link->medium) && $link->medium != null) {
            $social_html[] = '<li><a href="' . $link->medium . '"><em class="fab fa-medium-m"></em></a></li>';
        }
        if (isset($link->telegram) && $link->telegram != null) {
            $social_html[] = '<li><a href="' . $link->telegram . '"><em class="fab fa-telegram-plane"></em></a></li>';
        }
        if (isset($link->instagram) && $link->instagram != null) {
            $social_html[] = '<li><a href="' . $link->instagram . '"><em class="fab fa-instagram"></em></a></li>';
        }
        if (isset($link->reddit) && $link->reddit != null) {
            $social_html[] = '<li><a href="' . $link->reddit . '"><em class="fab fa-reddit"></em></a></li>';
        }
        if (isset($link->discord) && $link->discord != null) {
            $social_html[] = '<li><a href="' . $link->discord . '"><em class="fab fa-discord"></em></a></li>';
        }

        $return = '';
        $social_exist = count($social_html) > 0;
        if ($social_exist) {
            $return = '<ul' . $g_id . ' class="socials' . $g_cls . '">';
            foreach ($social_html as $social) {
                $return .= $social;
            }
            $return .= '</ul>';
        }
    ...
    public static function token_sales_progress($data = null, $atttr = '')
    {
        ...
        $sales_state = '';
        if (!hide_opt_count()) {
            $sales_end_in .= '<span class="card-sub-title ucap mgb-0-5x">'.__(active_stage()->name . ' Ends in').'</span><div class="countdown-clock" data-date="'._date(active_stage()->end_date, 'Y/m/d H:i:s').'"></div>';
