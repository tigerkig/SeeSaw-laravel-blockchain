                        ...
                        <div class="tab-content" id="website-setting">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-lg-6 col-sm-12">
                                            <div class="input-item input-with-label">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <label class="input-item-label">Enforce Email Verfification</label>
                                                        <div class="input-wrap input-wrap-switch">
                                                            <input class="input-switch input-switch-sm" type="checkbox" name="enforce_email_verification" id="enforce_email_verification" {{ get_setting('enforce_email_verification') == 1 ? 'checked' : '' }}>
                                                            <label for="enforce_email_verification">Enable</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="social_links">
                                <form action="{{ route('admin.ajax.settings.update') }}" class="validate-modern" method="post" id="update_social_settings">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-4 col-sm-12">
                                            <div class="input-item input-with-label">
                                                <label class="input-item-label">Discord</label>
                                                <div class="input-wrap">
                                                    <input class="input-bordered" type="url" placeholder="https://discord.gg/user-name" data-validation="required" name="social[discord]" value="{{ isset($links->discord) ? $links->discord : '' }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4 col-sm-12">
                                            <div class="input-item input-with-label">
                                                ...
                                                <div class="input-wrap">
                                                    <input class="input-bordered" type="url" placeholder="https://www.instagram.com/user-name" data-validation="required" name="social[instagram]" value="{{ isset($links->instagram) ? $links->instagram : '' }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4 col-sm-12">
                                            <div class="input-item input-with-label">
                                                <label class="input-item-label">Reddit</label>
                                                <div class="input-wrap">
                                                    <input class="input-bordered" type="url" placeholder="https://www.reddit.com/r/user-name" data-validation="required" name="social[reddit]" value="{{ isset($links->reddit) ? $links->reddit : '' }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="social_api">
                                <form action="{{ route('admin.ajax.settings.update') }}" method="post" class="validate-modern" id="update_api_settings" autocomplete="off">
                                    @csrf
                                    <input type="hidden" name="type" value="api_credentials">
                                    <div class="d-flex align-items-center justify-content-between pdb-1x">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between pdb-1x">
                                        <h5 class="card-title-md text-primary">HubSpot API Credentials</h5>
                                    </div>
                                    <div class="row">
                                        <div class="col-xl-6 col-sm-12 col-md-6">
                                            <div class="input-item input-with-label">
                                                <label class="input-item-label">API Key</label>
                                                <div class="input-wrap">
                                                    <input class="input-bordered" type="text" name="hubspot_api_key" value="{{ get_setting('hubspot_api_key') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-sm-12 col-md-6">
                                            <div class="input-item input-with-label">
                                                <label class="input-item-label">Business Unit ID</label>
                                                <div class="input-wrap">
                                                    <input class="input-bordered" type="text" name="hubspot_business_unit_id" value="{{ get_setting('hubspot_business_unit_id') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-sm-12 col-md-6">
                                            <div class="input-item input-with-label">
                                                <label class="input-item-label">Pipeline ID</label>
                                                <div class="input-wrap">
                                                    <input class="input-bordered" type="text" name="hubspot_pipeline_id" value="{{ get_setting('hubspot_pipeline_id') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-sm-12 col-md-6">
                                            <div class="input-item input-with-label">
                                                <label class="input-item-label">Start Deal Stage ID</label>
                                                <div class="input-wrap">
                                                    <input class="input-bordered" type="text" name="hubspot_deal_stage_start_id" value="{{ get_setting('hubspot_deal_stage_start_id') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-sm-12 col-md-6">
                                            <div class="input-item input-with-label">
                                                <label class="input-item-label">End Deal Stage ID</label>
                                                <div class="input-wrap">
                                                    <input class="input-bordered" type="text" name="hubspot_deal_stage_end_id" value="{{ get_setting('hubspot_deal_stage_end_id') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
