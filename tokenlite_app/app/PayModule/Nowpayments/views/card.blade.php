<div class="payment-card">
    <div class="payment-head">
        ...
        <div class="payment-logo">
            <img src="{{ asset('assets/images/pay-nowpayments-admin.png') }}" alt="NOWPayments">
        </div>
        <div class="payment-action">
            ...
            <div class="toggle-class dropdown-content dropdown-content-top-left">
                <ul class="dropdown-list">
                    ...
                    <li><a class="quick-action" href="javascript:void(0)" data-name="nowpayments">{{ $pmData->status == 'active' ? 'Disabled' : 'Enabled' }}</a></li>
                </ul>
            </div>
        </div>
    </div>{{-- .payment-head --}}
    <div class="payment-body">
        <h5 class="payment-title">NOWPayments Gateway</h5>
        <p class="payment-text">Receive online payments from contributors using NOWPayments.</p>
