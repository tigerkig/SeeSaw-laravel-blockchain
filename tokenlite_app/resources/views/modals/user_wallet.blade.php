    ...
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="popup-body popup-body-md">
                ...
                <p>{!!__('In order to receive your :SYMBOL token, please enter your wallet address below. You will receive your :SYMBOL token to this address after the token sale ends.', ['symbol' => '<strong>'.token_symbol().'</strong>' ]) !!}</p>
                    ...
                    <div class="tab-pane fade active show" id="wallet">
                        ...
                        <div class="d-sm-flex align-items-center">
                            <button id="submit" class="btn btn-primary">
                                {{__(has_wallet() ? 'Update Wallet' : 'Add Wallet')}}
                            </button>
                        </div>
                    </form>{{-- form --}}
                </div>
