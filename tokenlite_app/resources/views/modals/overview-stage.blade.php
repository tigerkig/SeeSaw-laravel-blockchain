            ...
            <div class="popup-body popup-body-md">
                ...
                <div class="popup-content">
                    <div class="card-bordered nopd">
                        ...
                        <div class="card-innr">
                            <div class="total-block">
                                <h5 class="total-title-sm">{{ __('Current Liquidity') }}</h5>
                                <span class="total-amount">{{ to_num($stage->liquidity, 'max').' '.$base_symbol }} <em class="fas text-light fa-info-circle fs-11 align-middle" data-toggle="tooltip" data-placement="right" title="The current liquidity of the token."></em></span>
                            </div>
                        </div>
                        @endif
                    </div>                    
