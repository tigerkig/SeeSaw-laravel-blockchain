...
class AdminController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $stage = IcoStage::dashboard();
        $users = User::dashboard($get_user);
        $trnxs = Transaction::dashboard($get_tnx);
        $progress_data = Transaction::progress();
        $country_data = User::top_countries();
        ...
        return view('admin.dashboard', compact('stage', 'users', 'trnxs', 'progress_data', 'country_data'));
    }
