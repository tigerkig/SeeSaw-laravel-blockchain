...
class APIController extends Controller
{
    ...
    protected function stage_data($type='')
    {
        ...
        $response_minimal = array(
            ...
            'price' => current_price(),
            'price_type' => $stage->price_type,
            'liquidity' => $stage->liquidity,
    ...
    public function price_chart()
    {
        ...
        $price_chart_data = Transaction::price_chart($minutes);
        $data = [
            'success' => true,
            'response' => $price_chart_data
        ];
    ...
    {
        $transaction_data = Transaction::recent();
